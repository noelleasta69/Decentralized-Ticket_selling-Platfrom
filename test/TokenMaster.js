...
describe("TokenMaster", () => {
  ...
  // ------------------------------------ Change ---------------------
  // describe("addEvent", () => {
  //   it("Allows venue owner to add an event", async () => {
  //     // Add venue owner
  //     await tokenMaster.connect(deployer).addVenueOwner(deployer.address);
  ...
  //     const occasion = await tokenMaster.getOccasion(2);
  //     expect(occasion.name).to.be.equal("New Event");
  //     expect(occasion.cost).to.be.equal(
  //       ethers.utils.parseUnits("0.5", "ether")
  //     );
  //     expect(occasion.tickets).to.be.equal(50);
  //     expect(occasion.date).to.be.equal("May 1");
  //     expect(occasion.time).to.be.equal("9:00AM");
  //     expect(occasion.location).to.be.equal("New York");
  //   });
  // });

  // describe("withdraw", () => {
  //   it("Allows contract owner to withdraw revenue", async () => {
  ...
  //     await tokenMaster
  //       .connect(buyer)
  //       .mint(1, 1, { value: ethers.utils.parseUnits("0.5", "ether") });
  //     await tokenMaster
  //       .connect(buyer)
  //       .mint(1, 2, { value: ethers.utils.parseUnits("0.5", "ether") });
